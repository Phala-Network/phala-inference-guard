# PIG v0.12.1 Advanced Configuration
...
- a deployment choice that genuinely differs from the v0.12.1 default.
...
environment. Every explicit `PREDICTIVE_*` value must differ from the v0.12.1
...
These values are part of the v0.12.1 behavior and should normally remain absent
