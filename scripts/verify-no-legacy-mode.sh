...
if search_active_go \
    'DYNAMIC_|KV_ADMISSION_|BACKEND_PRIORITY_|OPENAI_COMPAT_STRIP_EMPTY_TOOL_CALLS|GLOBAL_LIMIT|QOS_QUEUE|X-PIG-(Lane|Tier|Output-Tokens|Backend)|X-User-Tier' \
