...
func TestWritePredictiveAdmissionExposesTPSOnlyState(t *testing.T) {
	...
	WritePredictiveAdmission(&output, PredictiveAdmissionInput{
		...
		CapacityProjectedRunning:          6,
		CapacityProjectedWindowSequences:  2,
	...
	for _, want := range []string{
		...
		"pig_predictive_admission_last_projected_running 7",
		"pig_predictive_capacity_projected_running 6",
		"pig_predictive_running_limit 192",
		`pig_predictive_running_limit_info{source="admin"} 1`,
		"pig_predictive_admission_last_projected_window_sequences 3",
		"pig_predictive_capacity_projected_window_sequences 2",
