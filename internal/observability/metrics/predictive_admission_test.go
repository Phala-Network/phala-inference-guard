...
func TestWritePredictiveAdmissionExposesCurrentOperationalState(t *testing.T) {
	...
	WritePredictiveAdmission(&out, PredictiveAdmissionInput{
		...
		AdmissionPrefillInputTokens:               1500,
		AdmissionFirstBytePendingPrefillInput:     600,
		AdmissionFirstBytePendingPrefillCompute:   500,
		AdmissionFirstBytePendingPrefillSequences: 3,
		AdmissionMaximumSequenceKVReservation:     1000,
		AdmissionDecodeSequences:                  4,
		AdmissionInputKVTokens:                    1600,
		AdmissionFirstByteCoverableInputKV:        400,
		AdmissionFirstBytePendingInputKV:          1200,
		AdmissionFutureKVTokens:                   800,
		...
		TPSWindowQualifiedSequenceSamples:         40,
	...
	for _, want := range []string{
		...
		"pig_predictive_request_aware_prefill_input_tokens 1500",
		"pig_predictive_request_aware_first_byte_pending_prefill_input_tokens 600",
		"pig_predictive_request_aware_first_byte_pending_prefill_compute_tokens 500",
		"pig_predictive_request_aware_first_byte_pending_prefill_sequences 3",
		"pig_predictive_request_aware_maximum_sequence_kv_reservation_input_tokens 1000",
		"pig_predictive_request_aware_decode_sequences 4",
		"pig_predictive_request_aware_input_kv_tokens 1600",
		"pig_predictive_request_aware_first_byte_coverable_input_kv_tokens 400",
		"pig_predictive_request_aware_first_byte_pending_input_kv_tokens 1200",
		"pig_predictive_request_aware_future_kv_tokens 800",
		...
		"pig_predictive_request_aware_mean_active_tps_proxy_valid 1",
		...
		"pig_predictive_tps_window_qualified_sequence_samples 40",
