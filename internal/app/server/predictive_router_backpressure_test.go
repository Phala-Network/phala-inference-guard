...
func TestFormatPredictiveStatusExposesProtectionAndRouterCapacity(t *testing.T) {
	line := formatPredictiveStatus(metrics.PredictiveAdmissionInput{
		...
		RequestAwarePostAdmitPendingPrefillTokens: 2000, RequestAwarePendingLongPrefillSequences: 1,
		RequestAwareLastDecisionPendingPrefillSequences: 2, RequestAwareLastDecisionPendingPrefillTokens: 2000,
		RequestAwareLastDecisionPostAdmitPendingPrefillTokens: 3500, RequestAwareLastDecisionPendingLongPrefillSequences: 1,
		RouterBackpressure: metrics.PredictiveRouterBackpressureInput{
	...
	for _, want := range []string{
		...
		"request_aware=size_protect/request_size/tps", "pressure=0.600", "size=1500/1600/1333", "prefill_last=weighted/1500/2/2000/3500/1/0", "prefill_current=2/2000/1/0", "kv=7000/8600/2000", "load=4/1/4", "tps=80.000/20.000/16.000/1",
