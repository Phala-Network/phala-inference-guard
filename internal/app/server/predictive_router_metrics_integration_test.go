...
func TestPredictiveRejectProjectsProtectionIntoRouterConsumedMetrics(t *testing.T) {
	...
	predictiveShadow := &routerMetricsPredictiveShadow{telemetry: predictiveAdmissionTelemetrySnapshot{
		...
		Learning: runtimepredictive.LearnedSchedulerSnapshot{
			HardExistingTPSAdverse: 1,
			HardNewTPSAdverse:      1,
			HardTPOTAdverse:        1,
			HardExistingTPSOrigins: runtimepredictive.HardAdverseOriginSnapshot{Exploratory: 1},
			HardNewTPSOrigins:      runtimepredictive.HardAdverseOriginSnapshot{NonExploratory: 1},
			HardTPOTOrigins:        runtimepredictive.HardAdverseOriginSnapshot{Exploratory: 1},
		},
		ExistingPrefill: predictiveExistingPrefillObservationSnapshot{
			Accepted: 1, LastExistingUserTPS: 1.998185, LastExistingUserTPSValid: true, LastExploratory: true,
		},
