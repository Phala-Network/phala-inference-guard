...
`)
	...
	if predictiveApproximatePredictorVersion != "adaptive-tps-kv-v7" {
		t.Fatalf("model-neutral predictor version = %q, want isolated v0.10.10 QoS evidence semantics", predictiveApproximatePredictorVersion)
	}
